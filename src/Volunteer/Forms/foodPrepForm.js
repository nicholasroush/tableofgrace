...
export function FoodPrep() {
    const [volOption, setVolOption] = useState('Food Prep');
    const [firstName, setFirstName] = useState('');
    const [lastName, setLastName] = useState('');
    const [email, setEmail] = useState('');
    const [phone, setPhone] = useState('');
    const {prepDisplay} = useContext(formContext);
    ...
    return (
        <Form className="food-prep" onSubmit={handleSubmit} style={prepDisplay}>
